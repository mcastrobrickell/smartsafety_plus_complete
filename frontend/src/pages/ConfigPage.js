...
export default function ConfigPage() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50" data-testid="config-page">
      <Sidebar />
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
                      ...
                      {organization?.logo_url ? (
                        <div className="relative group">
                          <img
                            ...
                            className="max-h-32 max-w-full object-contain rounded-lg border border-slate-200 p-2"
            ...
            <TabsContent value="categories" className="space-y-6">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-lg font-semibold text-slate-900">Categorias Configurables</h2>
                ...
                <Dialog open={showCategoryDialog} onOpenChange={(open) => {
                  ...
                  <DialogTrigger asChild>
                    <Button className="bg-blue-500 hover:bg-blue-600 rounded-lg gap-2" data-testid="add-category-btn">
                  ...
                  <DialogContent>
                    ...
                    <DialogFooter>
                      ...
                      <Button onClick={handleSaveCategory} className="bg-blue-500 hover:bg-blue-600 gap-2">
                        <Save className="w-4 h-4" />
            ...
            <TabsContent value="cost-centers" className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <Dialog open={showCostCenterDialog} onOpenChange={(open) => {
                  ...
                  <DialogTrigger asChild>
                    <Button className="bg-blue-500 hover:bg-blue-600 rounded-lg gap-2" data-testid="add-cost-center-btn">
                      <Plus className="w-4 h-4" />
                  ...
                  <DialogContent>
                    ...
                    <DialogFooter>
                      ...
                      <Button onClick={handleSaveCostCenter} className="bg-blue-500 hover:bg-blue-600 gap-2">
                        <Save className="w-4 h-4" />
