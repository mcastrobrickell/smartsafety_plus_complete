...
export default function Scan360Page() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50" data-testid="scan360-page">
      <Sidebar />
      <main className="flex-1">
        <TopBar title="Scan 360° - Análisis de Seguridad">
          <Dialog open={showUploadDialog} onOpenChange={setShowUploadDialog}>
            <DialogTrigger asChild>
              <Button className="bg-amber-500 hover:bg-amber-400 text-slate-900 rounded-sm gap-2" data-testid="new-scan-btn">
        ...
        <div className="p-8">
          ...
          <Card className="border-amber-200 bg-amber-50 mb-8">
            <CardContent className="p-4 flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 font-['Manrope']">Análisis de Seguridad con IA</h3>
                ...
                <CardContent>
                  {loading ? (
                        ...
                        >
                          <div className="flex items-start justify-between">
                            ...
                            <div className="text-right flex flex-col items-end gap-2">
                              <div>
                                <p className="text-lg font-bold text-slate-900">{scan.findings_count}</p>
                    ...
                    <div className="text-center py-12">
                      ...
                      <Button
                        className="mt-4 bg-amber-500 hover:bg-amber-400 text-slate-900 rounded-sm"
                    ...
                    <div className="space-y-4">
                      ...
                      {scanDetails.scan.summary && (
                        <div className="p-4 bg-slate-50 rounded-sm">
                          ...
                          <p className="text-sm text-slate-600">{scanDetails.scan.summary}</p>
                        </div>
                      )}
                          ...
                          {scanDetails.findings.length > 0 ? (
                            <div className="space-y-3">
                              {scanDetails.findings.map((finding) => (
                                <div key={finding.id} className="p-3 border border-slate-200 rounded-sm">
