...
export default function ProfilesPage() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50" data-testid="profiles-page">
      <Sidebar />
      <main className="flex-1">
        <TopBar title="Gestión de Perfiles">
          <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
            <DialogTrigger asChild>
              <Button className="bg-blue-500 hover:bg-blue-600 rounded-lg gap-2" data-testid="add-profile-btn">
            ...
            <DialogContent className="max-w-lg">
              ...
              <DialogFooter>
                ...
                <Button onClick={handleCreate} className="bg-blue-500 hover:bg-blue-600 rounded-lg" data-testid="save-profile-btn">
                  Crear Usuario
                </Button>
              </DialogFooter>
            </DialogContent>
          ...
          <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
            <DialogContent className="max-w-lg">
              ...
              <DialogFooter>
                ...
                <Button onClick={handleUpdate} className="bg-blue-500 hover:bg-blue-600 rounded-lg">
                  Guardar Cambios
                </Button>
              </DialogFooter>
            </DialogContent>
