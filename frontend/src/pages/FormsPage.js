...
export default function FormsPage() {
      ...
      case 'checkbox':
        return (
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor={field.id} className="text-sm text-slate-400 cursor-pointer">
  ...
  return (
    <div className="flex min-h-screen bg-dark-bg" data-testid="forms-page">
      <Sidebar />
          ...
          <Card className="border-green-200 bg-green-50 mb-6">
            <CardContent className="p-4 flex items-center gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-white">Integración SmartForms+</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {templates.map((template) => {
                    ...
                    return (
                      <Card 
                        key={template.id} 
                        className="border-cyan-accent/10 hover:border-blue-300 hover:shadow-md transition-all cursor-pointer"
              ...
              {submissions.length > 0 ? (
                <div className="space-y-3">
                  {submissions.map((sub) => {
                    ...
                    return (
                      <Card key={sub.id} className="border-cyan-accent/10">
