...
export default function EPPDeliveriesPage() {
  ...
  return (
    <div className="flex min-h-screen bg-dark-bg" data-testid="epp-deliveries-page">
      <Sidebar />
      <main className="flex-1">
        ...
        >
          ...
          <Button onClick={() => setShowDeliveryDialog(true)} className="btn-primary gap-2">
                            ...
                            <TableRow key={delivery.id}>
                              ...
                              <TableCell>
                                {delivery.signature_confirmed ? (
                                  ...
                                  <Badge className="bg-slate-100 text-slate-400">Pendiente</Badge>
                                )}
                              </TableCell>
                              <TableCell>
                                <Button 
        ...
        <Dialog open={showDeliveryDialog} onOpenChange={setShowDeliveryDialog}>
          <DialogContent className="max-w-3xl max-h-[90vh]">
            ...
            <DialogFooter>
              ...
              <Button onClick={handleCreateDelivery} className="btn-primary">
                Registrar Entrega
              </Button>
            </DialogFooter>
          </DialogContent>
