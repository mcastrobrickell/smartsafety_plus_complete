...
export default function UsersPage() {
  ...
  return (
    <div className="flex min-h-screen bg-dark-bg" data-testid="users-page">
      <Sidebar />
      <main className="flex-1">
        <TopBar title="Gestión de Usuarios">
          <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
            <DialogTrigger asChild>
              <Button className="bg-amber-500 hover:bg-amber-400 text-white rounded-sm gap-2" data-testid="add-user-btn">
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <Card className="stat-card">
              <CardContent className="p-6 flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-white font-['Manrope']">{users.length}</p>
            ...
            <Card className="stat-card">
              <CardContent className="p-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Supervisores</p>
                </div>
              </CardContent>
            </Card>
            <Card className="stat-card">
              <CardContent className="p-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Inspectores</p>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
            <DialogContent>
              ...
              {selectedUser && (
                <div className="space-y-4 py-4">
                  <div className="flex items-center gap-3 p-4 bg-dark-bg rounded-sm">
