...
export default function FindingsPage() {
  ...
  return (
    <div className="flex min-h-screen bg-dark-bg" data-testid="findings-page">
      <Sidebar />
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            <Card className="stat-card">
              <CardContent className="p-4">
                <p className="text-2xl font-bold text-white font-['Manrope']">{stats.total}</p>
                <p className="text-sm text-slate-400">Total Hallazgos</p>
              </CardContent>
            </Card>
            <Card className="stat-card">
              <CardContent className="p-4">
                    ...
                    {filteredFindings.map((finding) => (
                      <TableRow key={finding.id} data-testid={`finding-row-${finding.id}`}>
                        ...
                        <TableCell className="max-w-md">
                          <p className="text-sm text-white truncate">{finding.description}</p>
